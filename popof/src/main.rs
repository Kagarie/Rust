#[derive(Debug)]
struct Personnage {
	//les string ont besoin d avoir une duree de vie la connaissant pas pour ce programme j'utilise " &'static " pour lui dire que il mourra à la fin du programme 
	nom: &'static str,
